...
SDL_AppResult Game::SDL_AppIterate()
{
    ...
    if (showMenu) {
        ...
        tileMap->renderLayer(renderer, camera->getView(), u8"Слой тайлов 1");
        tileMap->renderLayer(renderer, camera->getView(), u8"Слой тайлов 2");      // или как у тебя называется основной слой
